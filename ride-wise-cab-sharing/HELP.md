...
* The original package name 'com.example.RideWise.ride wise cab sharing ' is invalid and this project uses 'com.example.RideWise.ride.wise.cab.sharing' instead.
